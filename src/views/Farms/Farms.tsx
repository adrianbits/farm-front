...
const Farms: React.FC = () => {
  ...
  const rowData = farmsStakedMemoized.map((farm) => {
    ...
    const lpLabel = farm.lpSymbol && farm.lpSymbol.split(' ')[0].toUpperCase().replace('PANTENDIE', '')
  ...
  return (
    <>
      ...
      <Page>
        ...
        {renderContent()}
        <div ref={loadMoreRef} />
        <StyledImage src="/images/3dpan.png" alt="Pancake illustration" width={500} height={300} />
      </Page>
    </>
  )
}
